  ...
  >
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white">Nehal</h4>
          <p className="mt-[8px] font-normal sm:text-[18px] text[12px] sm:leading-[22px] leading-[16px] text-white">Founder | Metaverse</p>
          <p className="mt-[24px] font-normal sm:text-[24px] text[12px] sm:leading-[45px] leading-[39px] text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laudantium officia at voluptatibus quos eaque, quidem odio labore maxime ducimus laboriosam.</p>
        </div>
      </motion.div>
      <motion.div
