  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      <div className="flex items-center justify-between flex-wrap gap-5">
        ...
        <button
          type="button"
          className="flex items-center h-fit py-4 px-6 bg-[#25628b] rounded-[32px] gap-[12px]"
        >
          <img
            src="/headset.svg"
            alt="button-img"
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <p className="font-normal text-[14px] text-white opacity-50">Copyright- 2023©All Rights Not Reserved! -by Nehal</p>
